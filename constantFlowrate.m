...
%Variables
    ...
    flowrate = 3.0;                             %Initial flowrate [L/min]
%%
%%%%%%%%%%%%%%
%Calculations%
%%%%%%%%%%%%%%
...
annotation('textarrow',[0.8 0.90], [0.87 0.835] ,'String','T = 317.4 K');
annotation('textarrow', [0.25 0.15], [0.18 0.16], 'String', 'Thermocline effect');
